...
@Entity
@Table(name = "table_rental_purchases",
        indexes = {
                @Index(name = "ix_trp_user", columnList = "user_id"),
                @Index(name = "ix_trp_pkg",  columnList = "package_id"),
                @Index(name = "ix_trp_pi",   columnList = "stripe_payment_intent_id")
        })
public class TableRentalPurchase {
    ...
    private TableRentalPackage pack;
    ...
    public TableRentalPackage getPack() { return pack; }
    public void setPack(TableRentalPackage pack) { this.pack = pack; }
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof TableRentalPurchase that)) return false;
